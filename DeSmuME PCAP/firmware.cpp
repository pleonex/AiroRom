...
bool CFIRMWARE::load()
{
	...
	// Fix to load correctly the DeSmuME Firmware Config file.
	for (int pos = 0; CommonSettings.Firmware[pos + 4] != '\0'; pos++)
		MMU.fw.userfile[pos] = CommonSettings.Firmware[pos];
	strcat(MMU.fw.userfile, ".dfc");
