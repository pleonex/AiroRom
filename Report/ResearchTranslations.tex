...
Si bien parte de la cabecera para las paletas y datos de imagen si se reutiliza, existe un conjunto de formatos extras únicos en este juego con la información necesaria para recomponer la imagen (figura~\ref{fig:tr-blackimg}).
...
De esta forma los programas de ediciones genéricas creados para juegos de \acl{Nintendo DS} ya no son útiles y se necesita nuevos y específicos.
...
\section{Ni no kuni y el Mago de las Tinieblas}
