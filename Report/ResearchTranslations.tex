...
Después de aplicar la mecánica descrita en la sección~\ref{sec:mec-search-text} se ha encontrado que los textos están cifrados y codificados.
...
Esta codificación está implementada en ambos sentidos en el proyecto AmbitionText\footnote{\url{https://github.com/pleonex/Pokemon-Conquest-Tools/AmbitionText}}.
