...
Los textos se ha encontrado que estaban cifrados tras aplicar ambos procedimientos descritos en metodología de la sección~\ref{sec:met-search-tex}.
Respecto al primero, una búsqueda de la fuente para determinar la codificación, en la tabla~\ref{tab:tr-pearlfont} se especifica el formato de las tipografías.
