...
Entendiéndose esta como el proceso de analizar una aplicación para entender cómo funciona y cómo integra cada uno de sus recursos.
...
It is not only about entertainment but education, specially for children, for instance, to learn new languages and help with mathematics.

All that benefit makes to think about how to protect against possible `attacks'.
They started fighting piracy with Digital Rights Management techniques, that is, releasing copy of games without permissions from the author, but nowadays it touches more fields.
...
Communication protocols for online services, download content protection and wireless code transmission will be dealt with too.
