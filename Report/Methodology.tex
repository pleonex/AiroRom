...
Para determinar el número de ficheros se puede calcular cuantos archivos especifica esa \textit{tabla de contenidos}, restando el principio del primer fichero a la posición de la primera entrada y diviendo por el número de bytes dedicado a cada entrada: \verb!(0x54 - 0x0C) / 0x08 = 9!.
...
Sin embargo, dado que las cabeceras de la imagen suelen ser estandar, se puede buscar sobre el código en ensamblador la función que la procesa.
