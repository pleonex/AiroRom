...
Al proteger los archivos e imposibilitar su extracción, se permite abrir el mercado ante la posibilidad de vender la banda sonora de forma externa como pasó con este juego\footnote{La banda sonora se podía comprar en esta tienda virtual. \url{http://www.play-asia.com/ni-no-kuni-shikkoku-no-madoushi-original-soundtrack/13/704299}}.

Caso distinto es la versión para \acl{PS3}\footnote{Esta banda sonora también se vendió aparte. \url{http://www.amazon.com/Ni-Kuni-Wrath-Original-Soundtrack/dp/B00DRS6UKQ}} de este juego dado que el formato de los archivos es estándar y se puede reproducir con programas como \url{http://www.videolan.org/vlc/}{VLC}.
