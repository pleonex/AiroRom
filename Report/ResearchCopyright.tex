...
\ctable[
    ...
    \textsf{0x00} & \textsf{0x04} & Identificador: \texttt{PSAR}        \NN
    \textsf{0x04} & \textsf{0x04} & Versión: \texttt{0x00010004}        \NN
    \textsf{0x08} & \textsf{0x04} & Compresión: \texttt{zlib}           \NN
    \textsf{0x0C} & \textsf{0x04} & Posición de los datos               \NN
    \textsf{0x10} & \textsf{0x04} & Tamaño de la siguiente sección      \NN
