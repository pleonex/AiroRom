...
Para este último se permite varias codificaciones: \ac{PCM} de 8 bits, \ac{PCM} de 16 bits y \ac{IMA-ADPCM} siendo esta la que más calidad provee y el que se usa en estos juegos (figura~\ref{fig:cr-elite}).
...
Al ser un juego famoso, ha habido investigaciones sobre el formato de los ficheros. Destaca la siguiente \href{http://www.scorehero.com/forum/viewtopic.php?t=67124}{entrada} de foro donde se describe como extraer las canciones. La estructura de este formato se describe en la tabla~\ref{tab:cr-guitarHero}.
