...
Los mecanismos de seguridad se definen a este respecto, como los procedimientos para garantizar la seguridad.
En los siguientes apartados se introduce a los más comunes y que se tratarán a lo largo del proyecto.

\subsection{Cifrado simétrico y asimétrico}
El cifrado es un técnica para garantizar la confidencialidad.
Partiendo de un texto plano, es decir los datos originales de entrada, se aplica un algoritmo con una clave dada.
El resultado es otra representación del texto original, de la cual no se puede recuperar la información original sin conocer los detalles del cifrado.

Los algoritmos se basan en operaciones de sustitución y transposición, reordenación de bloques de datos.
