...
Cuando la consola pide datos al cartucho, estos pasan por el módulo de descifrado de la consola y se almacenan en la memoria RAM.
...
Para incrementar la seguridad se colocaron los componentes de la consola estratégicamente, de forma que era muy complicado extraer la memoria RAM para poder acceder a ella ya que se encontraba `pegada' debajo de la CPU.
