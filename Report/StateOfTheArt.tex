...
El cifrado es una técnica para garantizar la confidencialidad.
Partiendo de un texto plano, es decir, datos originales de entrada, se aplica un algoritmo con una clave dada generando un texto cifrado.
Este resultado es otra representación del texto original, de la cual no se puede recuperar la información original sin conocer los detalles del cifrado.
