...
\begin{itemize}
    \item Introducir en el tema y su importancia en proteger comunicación.
    \item Seguridad no puede depender del juego (Layton 4).
    \item Fallo de seguridad en servidores de Nintendo.
    \item Antiguo fallo de seguridad en Clash of Clans, Wally y Duet
    \item Fallo en Preguntados.
    \item Seguridad en Ninokuni.
\end{itemize}
...
Abriendo la de mayor tamaño, \textit{persistent-data.db}, y gracias a su nombre que nos indica que hay datos persistentes, es decir, constantes en cada ejecución del juego nos encontramos las filas de la figura~\ref{fig:c6-duet}.
