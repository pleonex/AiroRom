...
A parte de los problemas de seguridad y confidencialidad que esto implica, esto permitiría crear un programa que responda automáticamente a las preguntas.
...
Una posible solución a parte de usar \texttt{HTTPS} sería, que el servidor envíe solo las preguntas con sus posibles respuestas, y que la respuesta escogida se comunique al servidor donde se comprobaría.
