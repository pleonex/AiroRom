...
Para solventar este problema, Nintendo introdució una comprobación de seguridad que a diferencia de la que se aplica sobre el archivo principal, esta se realizar durante la ejecución del juego.
...
En otro caso, como el de un inicio normal desde el cartucho, se asume que no es necesario pues no han tenido modificacion externas.

Ese valor está desactivado en emuladores como DeSmuME y \textit{flashcards} para poder aplicar parches antipiratería y saltarse el mencanismo.
De esta forma, una vez modificado el juego original, se puede envíar a otras consolas el juego editado, permitiendo ejecutar código no seguro.
