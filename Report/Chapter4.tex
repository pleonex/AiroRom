...
La compresión en este caso fue obvia pues en la posición \verb!0x0C! se encuentra en ASCII la cadena de caracteres \verb!zlib! (figura~\ref{fig:c4-psar}).
...
Su formato en este caso no es frecuente pero tampoco difícil de analizar pues yendo extrayendo un bloque de datos, sistemas operativos con reconocimiento automático de formato detectan que es \emph{JPEG}.
