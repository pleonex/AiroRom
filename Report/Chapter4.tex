...
\paragraph{100 Classic Book Collection}~\\
...
\ctable[
    ...
    \textsc{0x70} & \textsc{0x04*23} & Tamaño de cada bloque            \NN
...
\begin{itemize}
    \item Juegos de NDS con música
    \item Música en Ninokuni / Layton
    \item Música del juego de iOS
\end{itemize}
