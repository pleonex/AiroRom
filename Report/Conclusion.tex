...
Todos los objetivos propuestos han sido alcanzados, estudiando un total de 23 juegos.
...
El segundo fue crear un depurador de código para \acl{NDS} llamado \textit{NitroDebugger}\footnote{\url{https://github.com/pleonex/NitroDebugger}}, del cual se ha terminado su núcleo y faltaría crear una interfaz gráfica y un programa desensamblador.
...
En cuanto a objetivos académicos, se ha sido capaz de identificar un problema no tratado en la literatura (no existen publicaciones en revistas científicas), organizar un trabajo en tareas e investigarlas.
Se ha realizado software adicional en los lenguajes \texttt{C\#} y \texttt{python} para complementar la investigación y se ha usado un control de versiones (\texttt{git}).
Durante el trabajo se han tocado conceptos de bajo nivel de software y hardware, estudiando protocolos y componentes de la \acl{NDS}, así como su lenguaje ensamblador, \texttt{ARM}.
...
En la primera sección de este capítulo se mencionarán y resumirán los mecanismos de seguridad encontrados, proponiendo en algunos casos métodos para fortalecerlas.
